...
public class ImageViewWithBorder extends ImageView {
    ...
    private void initViewParameter(Context context, AttributeSet attrs) {
        ...
        borderColor = mTypedArray.getColor(R.styleable.ImageViewWithBorder_imageview_borderColor, 0xffffff);
        borderCorner = mTypedArray.getDimension(R.styleable.ImageViewWithBorder_imageview_borderCorner, 2);
        borderWidth = mTypedArray.getDimension(R.styleable.ImageViewWithBorder_imageview_borderWidth, 2);
        mTypedArray.recycle();
        paint = new Paint();
    }
